...
if len(sys.argv) < 11:
    print("Usage: python", sys.argv[0], "<num_diversity> <init_train_epochs> <init_lr> <retrain_epochs> <retrain_lr> <ack batch size> <ei diversity measure> <ucb> <output dir> <suffix>")
    sys.exit(1)

num_diversity, init_train_epochs, train_lr, retrain_num_epochs, retrain_lr, ack_batch_size, ei_diversity_measure, ucb, output_dir, suffix = sys.argv[1:]
